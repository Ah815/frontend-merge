...
const LoginPage = ({ navigation }) => {
  ...
  const loginFunc = async (values) => {
    ...
    try {
      ...
      // const endpoint = "https://final-fyp-backend.vercel.app/login";
      const endpoint = "https://store-backend-sage.vercel.app/api/users/login";
      const data = values;
      ...
      if (response.status === 200) {
        ...
        console.log("ye response wala data hai", response.data);
  ...
  return (
    <ScrollView style={{ backgroundColor: COLORS.white }}>
      <View style={{ marginHorizontal: 20, marginTop: 50 }}>
        ...
        <Text style={styles.titleLogin}>Avian Family</Text>
